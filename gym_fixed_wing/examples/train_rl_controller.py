...
def monitor_training(_locals, _globals):
    ...
    :return:
    """
    global curriculum_level, last_ep_info, info_kw, log_interval, curriculum_cooldown, render_interval, last_render, render_check, model_folder, test_interval, last_test, checkpoint_save_interval, last_save, test_set_path, config_path
