...
class FixedWingAircraft(gym.Env):
    def __init__(
        ...
        # TODO: describe -> init observation vector?
        obs_low = []
        obs_high = []
        ...
        # TODO: describe -> init action vector?
        action_low = []
        action_space_low = []
        action_high = []
        action_space_high = []
    ...
    def reset(self, state=None, target=None, **sim_reset_kw):
        ...
        # sample reward factors uniformly if randomized scaling is disabled
    ...
    def get_reward(self, action=None, success=False, potential=False):
        ...
        # value is calculated to be scaled by a weight and then added to the reward
